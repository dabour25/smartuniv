	        ...
	        <div class="card-body">
	        	<form action="/admin/addperiod" method="post">
	                ...
	                <div class="to" style="width: 25% ; float: left ; margin-left: 10%;padding-bottom: 5%  ">
	                      ...
	                      <input type="text" class="form-control" name="to" placeholder="10:30AM">
	                  </div>
	            ...
	            @if(isset($pid))
	            <form action="/admin/editperiod/{{$pid}}" method="post">
	        		@csrf
		        	<div class="form-period" style="width: 25%; float: left;  margin-left: 5% ">
	                      <label for="Periodname"><b>Period</b></label>
		            ...
		            <a href="/admin/periods" class="btn btn-danger" style="width: 30% ; margin:10px 35%">
		                Back
		            </a>
	            </form>
	            @endif
                ...
                <table class="table table-dark" >
                    ...
                    <tbody>
                    	@foreach($per as $p)
                        <tr>
                            <td><a href="/admin/editperiod/{{$p->id}}">{{$p->name}}</a></td>
                            <td>{{$p->start_time}}</td>
                            <td>{{$p->end_time}}</td>
                        </tr>
                        @endforeach
