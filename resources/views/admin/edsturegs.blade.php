...
<div id="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit Student Registeration</li>
      </ol>
    ...
    <!-- Page Content -->
      ...
      <div class="col-sm-12">
                ...
                <form action="/admin/edsturegs/{{$stu->sid}}" method="post">
                    @csrf
                <div class="check-box-div">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="cousec[{{$co->id}}]">
                                        ...
                                        <option value="{{$se->id}}" 
                                            @foreach($oldreg as $o)
                                            @if($se->id==$o->section&&$co->id==$o->course_id)
                                            selected
                                            @endif
                                            @endforeach
                                        >{{$se->section}}</option>
                    ...
                    <button type="submit" class="btn btn-success">Edit Register</button>
                </div>
                </form>
            </div>
    </div>
